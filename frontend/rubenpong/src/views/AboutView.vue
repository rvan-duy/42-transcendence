...
function onclickMeow() {
  ...
  if (about_text_element.innerHTML === "cat")
    ...
    fetch(
      ...
      .then((res) => res.text())
      .catch((res) => console.log("Error - Result: ", res))
      .then((data) => (about_text_element.innerHTML = data))
...
<template>
  <div class="about">
    <h1 id="about_text">This is an about page</h1>
    <button @click="onclickMeow">Meow</button>
  </div>
</template>
