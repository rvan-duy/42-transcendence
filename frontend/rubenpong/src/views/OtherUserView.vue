      ...
      <div class="join-container">
        <header class="join-header">
          <div style="text-align: center;">
            <span>
              <img src="../assets/dagmar.jpeg" width="50" height="50"
                style="border-radius: 50%; display:block;margin-left: auto; margin-right: auto">
              <figcaption class="text-white text-m">
                {{ name }}
              </figcaption>
              <button class="bg-blue-300 hover:bg-blue-400 text-white text-xs py-1 px-2 rounded-full m-2"
        ...
        <main class="join-main">
          ...
          <button class="bg-blue-300 hover:bg-blue-400 text-white text-xs py-1 px-2 rounded-full mr-2"
            style="float: right" @click="goTo('chatroom/AwesomeChat')">
            Send message
          </button>
          ...
          <div v-else-if="matches_played > 0">
            <div v-for="match in matches" :key="match.player1">
